...
deltaF     = np.array( [81.55 ,84.506  , 88.49    , 89.83  ]) # KJ/mol
...
deltaU = inter
deltaU_err = inter_err
deltaS = -slope*1000
deltaS_err = slope_err*1000
...
plt.title(r'E=0.00 V/$\mathrm{\AA}$ ',fontsize=labelsize)
