...
for i in range(ndata):
    data=all_data[i]                                                                                                                                                                                       
    ax.plot(data[:,0],factor*data[:,1], label=r' {:3.2f} eV/A'.format(field[i]),linestyle=linestyle[i],color=colors[i])   


ax.set_xlabel(r'Frequency (cm $^{-1}$)', fontsize=labelsize)                                                                                                                                                
ax.set_ylabel(r"VDOS (arb. un.) ", fontsize=labelsize)                                                                                                                                             
filename='VDOS'
